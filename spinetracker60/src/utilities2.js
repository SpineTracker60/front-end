...
export const TRIANGULATION = [
  ...
  export let eye_ratio = '';
  export let face_size = '';
  // Drawing Mesh
  export const drawMesh = (predictions, ctx) => {
    if (predictions.length > 0) {
      predictions.forEach((prediction) => {
        const keypoints = prediction.keypoints.map((keypoints) => [
          keypoints.x,
          keypoints.y
        ]);
        //  Draw lines
        ...
        let eye_height = ((keypoints[159][1] - keypoints[145][1]) + (keypoints[386][1] - keypoints[374][1])) + (1 / 1e9) / 2;
